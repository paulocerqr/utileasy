...
TRANSCRIPTION_MAX_FILE_SIZE = int(os.getenv("TRANSCRIPTION_MAX_FILE_SIZE", 95 * 1024 * 1024))
TRANSCRIPTION_MAX_DURATION_SECONDS = int(os.getenv("TRANSCRIPTION_MAX_DURATION_SECONDS", 10800))
